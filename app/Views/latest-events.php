            ...
            <div class="inner-page-banner banner-bg">
                <div class="container">
                    <div class="banner-content">
                        ...
                        <h1 class="banner-heading">Latest Events</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="event-single">
                        <div class="event-picture"><img src="<?=base_url('assets/images/logo.jpg')?>"
                                alt="event-picture">
                            <div class="event-date-floating">
                                <span class="day"><?=date('d',strtotime($row['date']))?></span>
                                <span class="month"><?=date('F',strtotime($row['date']))?></span>
                                <span class="year"><?=date('Y',strtotime($row['date']))?></span>
                            </div>
                        </div>

                        <div class="contents">
                            <a href="<?=site_url('latest-events/details/')?><?=$row['event_title']?>"
                                class="event-title"><?=$row['event_title']?></a>
