...
<body>
            ...
            <div class="inner-page-banner banner-bg">
                <div class="container">
                    <div class="banner-content">
                        ...
                        <h1 class="banner-heading">INCOMING MATCHES</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php 
        ...
        {
            $startDate = $row->date." ".$row->time;
            $endDate = $row->date." ".$row->time;
            $tempArray = array( "title" =>$row->team1." vs ".$row->team2,
