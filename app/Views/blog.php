                ...
                <div class="col-xl-9 col-md-8">
                    <div class="news-feed-area">
                        ...
                        <div class="blog-item feed-blog-item">
                            <a href="<?=site_url('latest-news/stories/')?><?=$news['topic']?>" class="blog-picture"><img
                                    src="<?=base_url('admin/images/news/')?><?=$news['image']?>" alt="blog-image"></a>
                            <div class="contents">
                                <div class="flex-wrapper">
                                    <span class="catagory-tag"><?=$news['news_type']?></span>
                                    <div class="blog-author">
                                        <div class="author-dp">
                                            <img src="<?=base_url('assets/images/logo.jpg')?>" width="50px"
                                                alt="author-dp">
                                        </div>
                                        <span class="author-name">BY <?=$news['author']?></span>
                                    </div>
                                </div>
                                <a href="<?=site_url('latest-news/stories/')?><?=$news['topic']?>" class="blog-title">
                                    <?=$news['topic']?>
                                </a>
                                <?=$news['details']?>
                            </div>
