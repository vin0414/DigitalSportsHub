                ...
                <div class="col-xl-9 col-md-8">
                    <div class="news-feed-area">
                        ...
                        <div class="blog-item feed-blog-item">
                            <a href="<?=site_url('latest-news/stories/')?><?=$row['topic']?>" class="blog-picture"><img
                                    src="<?=base_url('admin/images/news/')?><?=$row['image']?>" alt="blog-image"></a>
                            <div class="contents">
                                <div class="flex-wrapper">
                                    <span class="catagory-tag"><?=$row['news_type']?></span>
                                    <div class="blog-author">
                                        <div class="author-dp">
                                            <img src="<?=base_url('assets/images/logo.jpg')?>" width="50px"
                                                alt="author-dp">
                                        </div>
                                        <span class="author-name">BY <?=$row['author']?></span>
                                    </div>
                                </div>
                                <a href="<?=site_url('latest-news/stories/')?><?=$row['topic']?>" class="blog-title">
                                    <?=$row['topic']?>
                                </a>
                                <p><?=substr($row['details'],0,200)?>...</p>
                            </div>
                        </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="news-right-widget">
                        <div class="widget widget-post mb-40">
                            <div class="widget-title-box pb-25 mb-30">
                                <h4 class="widget-sub-title2 fs-20">Headlines</h4>
                            </div>
                            <ul class="post-list">
                                <?php foreach($headlines as $row): ?>
                                <li>
                                    <div class="blog-post mb-30">
                                        <a href="<?=site_url('latest-news/stories/')?><?=$row['topic']?>"><img
                                                src="<?=base_url('admin/images/news/')?><?=$row['image']?>"
                                                width="100px" alt="Post Img"></a>
                                        <div class="post-content">
                                            <h6 class="mb-10">
                                                <a href="<?=site_url('latest-news/stories/')?><?=$row['topic']?>">
                                                    <?=substr($row['topic'],0,40)?>...
                                                </a>
                                            </h6>
                                            <span class="fs-14"><i class="fas fa-calendar-alt"></i>
