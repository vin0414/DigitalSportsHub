                        ...
                        <div class="card card-md">
                            <div class="card-body">
                                ...
                                <form action="<?=base_url('register')?>" method="POST" autocomplete="off" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="text-danger">
                                            <small><?=isset($validation)? display_error($validation,'name') : '' ?></small>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="text-danger">
                                            <small><?=isset($validation)? display_error($validation,'confirm_password') : '' ?></small>
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                ...
                                <div class="text-center text-secondary mt-3">Already have account?
                                    <a href="<?=site_url('login')?>" tabindex="-1">Sign in</a>
                                </div>
                            </div>
                        </div>
                    </div>
