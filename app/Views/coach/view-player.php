...
<body>
    ...
    {
        var val = $('#sports').val();
        var selectedSalaryGrade = "<?=$player['roleID'] ?>";
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#position').val(selectedSalaryGrade);
                $('#position option').each(function() {
                    if ($(this).val() === selectedSalaryGrade) {
                        $(this).prop('selected', true); // Manually set the option as selected
                    }
                });
            }
        });
