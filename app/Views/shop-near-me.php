                    ...
                    <div class="banner-content">
                        <div class="page-path">
                            <ul>
                                ...
                                <li><a class="current-page" href="<?=site_url('shop-near-me')?>"><?=$title?></a></li>
                            </ul>
                        </div>
                ...
                <div class="gallery-grid">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="side-content-title"><i class="fa-solid fa-store"></i>&nbsp;<?=$title?>
                                    </h4>
                                    <br />
                        ...
                        <div class="col-lg-3">
                            <div class="premier-league-area side-table-item side-item">
                                <div class="side-item-inner">
                                    <div class="card">
                                        <div class="card-body">
                                            <h3 class="side-content-title"><i
                                                    class="fa-solid fa-rectangle-list"></i>&nbsp;Recent Shops
                                            </h3>
                                            <table class="table">
                                                <tbody>
                                                        ...
                                                        <td>
                                                            ...
                                                            <small>
                                                                <a style="font-size:10px;"
                                                                    href="<?=$row['website'] ?>">Visit Website</a>
                                                            </small>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
